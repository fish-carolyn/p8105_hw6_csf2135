...
**Interpretation:** The odds of a homicide case in Baltimore, M being solved when victims were male is 0.43 times that of cases where victims were female, adjusting for the victim's age and race. At the 95% level of significance, a range of reasonable estimates for the odds ratio are between 0.32 and 0.56. The null hypothesis of an adjusted OR of 1 can be rejected. 
