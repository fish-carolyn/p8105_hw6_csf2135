...
tmin + prcp is: (0.8882079 - 0.9402552).

The 95% CI for the log(β̂1∗β2) is: (-8.6321499 - -4.6011529).
...
- show a plot of model residuals against fitted values – use
  add_predictions and add_residuals in making this plot.\[x\]
