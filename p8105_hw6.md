...
Looking at the distributions of race for moms and dads, some of the cell
sizes get pretty small for the Asian, Puerto Rican, and Other racial
categories. I will combine these for the sake of building this model
because I am unaware of any literature-based reason not to.
...
Yep, combining the racial groups will smaller sample sizes helps. Now
I’ll adjust for this re-categorization in the analytic data set.

I also make unordered categorical variables (`mrace` and `frace`) into
factors.
